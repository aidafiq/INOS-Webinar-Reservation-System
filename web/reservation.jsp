<%-- 
    ...
    Created on : Jun 8, 2023, 12:24:43 AM
    Author     : ASUS TUF F17
--%>
            ...
            <div class="tabs">
                <div>
                    <div class="reservation-form">
                        ...
                        <form id="reservationForm" method="POST" action="reservationAuth">
                            ...
                            <label for="desc">Speaker Name</label>
                            <input type="text" id="desc" name="speakername" required><br>
                ...
                <div>
                    <div class="reservation-list">
                        ...
                        <table id="reservationTable" action="reservationAuth" method="GET">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Email</th>
                            ...
                            <%
                                    ...
                                    String myURL = "jdbc:mysql://localhost:3306/inos";
                                    ...
                                    while (myResultSet.next()) {
                                        ...
                                        out.print("<td width=\"20%\">" + myResultSet.getString(2) + "</td>");
                                        out.print("<td width=\"20%\">" + myResultSet.getString(3) + "</td>");
                                        out.print("<td width=\"20%\">" + myResultSet.getString(4) + "</td>");
                                        out.print("<td width=\"20%\">" + myResultSet.getString(5) + "</td>");
                                        out.print("<td width=\"20%\">" + myResultSet.getString(6) + "</td>");
                                        out.print("<td width=\"20%\">"
                                                + "<a href='edit?id=" + myResultSet.getString(1) + "'>Edit</a>" + "&nbsp;&nbsp;&nbsp;&nbsp;<a href='reservationAuth?action=delete&id=" + myResultSet.getString(1) + "'>Cancel</a></td>");
                                        out.print("</tr>");
                                    }
                                    myConnection.close();
