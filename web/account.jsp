<%-- 
    ...
    Created on : Jun 8, 2023, 12:17:03 AM
    Author     : ASUS TUF F17
--%>
<%
        ...
        <body>
            ...
            <div class="tabbed">
                ...
                <div class="tabs">
                    <div>
                        <div class="container">
                            <form id="profileForm" method="POST" action="AccountAuth">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="matricNo" name="Matric" required>
                                </div>
                    ...
                    <div>
                        <div class="container">
                            <form id="profileForm" method="GET" action="AccountAuth">
                                <div class="form-group">
                                    <label for="name">Name:</label>
                                    <input type="text" id="name" name="Name" required>
                                </div>
